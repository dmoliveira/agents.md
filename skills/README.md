...
This folder stores polished repo-local instruction modules that complement `AGENTS.md`. They are repo-local guidance files, not runtime-registered skills by default.

Rules:

- `AGENTS.md` remains the source-of-truth operating contract.
